...
In the final work, we will extend this to provide additional tests and mathematical models of the low precision implementations. We will also test the performance when other parts of the algorithm such as the DPD learning are implemented in fixed-point arithmetic.
